...
$(document).ready(function() {
    if (document.getElementById('current-entries') !== null) {
        $('.span4.blue-square.ng-scope').after('<div class="span4 green-square ng-scope"><span class="square-describe mont"><span class="status small"><span class="current ng-binding" id="winning_chance">Calculating...</span></span></span><span class="description ng-binding">Winning Chance</span></span></div>');
